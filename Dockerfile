...
ENV PORT=3000 NODE_ENV=production PUBLIC_API_URL=https://api.ondacast.com
EXPOSE 3000
HEALTHCHECK --interval=30s --timeout=3s --retries=3 CMD wget -q --spider http://127.0.0.1:3000/ || exit 1
